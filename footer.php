...
<footer id="footer" class="footer border-top bg-light">
	...
	<div class="container">
		<div class="row d-flex py-3">
			...
			<div class="col-12 col-sm-6 text-center text-sm-left">&copy 2012 - <?php echo date('Y'); ?>: <a href="<?php echo get_site_url(); ?>" class="oskari"><?php echo get_bloginfo( 'name' ); ?></a></div>
