	...
	<div class="row">
		<?php foreach ( get_sub_field('logot') as $logo ) : ?>
			<div class="col-12 col-sm-6 col-lg-4 col-xl-3 ">
				<a href="<?php echo get_field('linkki', $logo['ID']); ?>" target="_blank" rel="noopener" class="d-flex w-100 h-100 justify-content-center align-items-center py-5 px-5 px-lg-4">
